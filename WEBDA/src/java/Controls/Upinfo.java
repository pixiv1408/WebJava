 ...
 * @author DELL
 */
@WebServlet(name = "Editfood", urlPatterns = {"/Upinfo"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if (login.getAccount() == null) {
                ...
                String FID = request.getParameter("FIDE");
                Foods food = new DAO().Fdetail(FID);
                List<Category> lc = new loadcate().listcate();
                request.setAttribute("Efood", food);
                request.setAttribute("FlistCate", lc);
